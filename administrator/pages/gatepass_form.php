            ...
            <form action="" method="post" class="thisform">
                ...
                <div class="selections">
                    <select name="itemdescription" id="selectdropdown18" class="form-control select2" class="option">
                        <?php
                        $result = $con->query("SELECT * FROM item_masterfile where cat_id in(1,2,4,6,7,9,11,12,14,15)") or die($con->query); ?>
        ...
        <div class="section-right">
            ...
            <table class="table-sortable" border="1" cellpadding="4" id="soldtable">
                ...
                <tbody>
                    <?php
                    if (mysqli_num_rows($_query1) > 0) {
                        while ($roww = mysqli_fetch_assoc($_query2)) {
                            $aa = $roww["id"];
                            $bb = $roww["itemdescription"];
                            $cc = $roww["gfrom"];
                            $dd = $roww["gto"];
                            $g_status = $roww["g_status"];
                            $durl = "gatepass_edit.php?sumid=$aa";
                            echo "<tr>";
                            if ($g_status == '') {
                                echo "<td style='color: #FAAD14;font-style=arial>$aa</td>";
                            }
                            echo "<td style='color: green;font-style=arial;'>$aa</td>";
                            if ($g_status == '') {
                                echo "<td style='color: #FAAD14;font-style=arial>$bb</td>";
                            }
                            echo "<td style='color: green;font-style=arial;'>$bb</td>";
                            if ($g_status == '') {
                                echo "<td style='color: #FAAD14;font-style=arial>$cc</td>";
                            }
                            echo "<td style='color: green;font-style=arial;'>$cc</td>";
                            if ($g_status == '') {
                                echo "<td style='color: #FAAD14;font-style=arial>$dd</td>";
                            }
                            echo "<td style='color: green;font-style=arial;'>$dd</td>";
                            echo "<td><a href='$durl'>EDIT</a></td>";
                            echo "</tr>";
                        }
                    }
