...
<nav class="menu">
    <ul>
        <li id="logo"><a href="../index.php"> <img src="../images/logo.png" alt=""></a></li>
        ...
        <li><a href="#">Reports <i class="fas fa-arrow-alt-circle-down"></i></a>
            <ul>
                ...
                <li><a href="./soldunit.php"><i class="fas fa-hand-holding-usd"></i> Sold unit</a>
        ...
        <li><a href="#"><i class="fas fa-cog"></i> Settings</a>
            <ul class="submenu">
                <li><a href="./gatepass-form.php"><i class="fas fa-user-tie"></i></i> Profile</a>
